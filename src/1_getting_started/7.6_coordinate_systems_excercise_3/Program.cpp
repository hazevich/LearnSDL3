    ...
    while (!_shouldQuit)
    {
        ...
        if (swapchainTexture != NULL)
        {
            ...
            for (size_t i = 0; i < 10; i++)
            {
                ...
                float angle = (i % 3 == 0) ? i * _time.TotalTime * 5 : i * 20.0f;
                model = glm::rotate(model, glm::radians(angle), glm::vec3(1.0f, 0.3f, 0.5f));

                glm::mat4 view = glm::mat4(1.0f);
                view = glm::translate(view, _cameraPosition);
...
void ProcessInput(const SDL_Event& event)
{
    ...
    {
        _cameraPosition.z += 10.0f * _time.DeltaTime;
    }
    ...
    {
        _cameraPosition.x += 10.0f * _time.DeltaTime;
    }
    ...
    {
        _cameraPosition.y -= 10.0f * _time.DeltaTime;
    }
